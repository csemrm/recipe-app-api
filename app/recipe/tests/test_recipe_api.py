...
def image_upload_rul(recipe_id):
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_other_user_recipe_delete_error(self):
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test create a new recipe with the existing tags."""
    ...
    def test_update_recipe_on_add_ingredients(self):
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        """Test uploading an images to a recipe."""
        url = image_upload_rul(self.recipe.id)
    ...
    def test_upload_image_bd_request(self):
